      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-8">
        ...
        >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-2xl border border-border bg-card py-3.5 text-sm font-semibold text-foreground shadow-art transition-all hover:shadow-elevated hover:border-secondary disabled:opacity-60 mb-5"
          >
